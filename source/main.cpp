...
private:
  ...
  void initWindow()
  {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "MFW", nullptr, nullptr);
  }
  ...
  void pickPhysicalDevice()
  {
    ...
    {
      if (isDeviceSuitable(candidate_device))
      {
        physicalDevice = candidate_device;
        break;
      }
    }
  ...
  {
    auto vertShaderCode = readFile("/Users/rich/Documents/mfw/build/dev/shader/shader.vert.bin");
    auto fragShaderCode = readFile("/Users/rich/Documents/mfw/build/dev/shader/shader.frag.bin");
  ...
  static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity [[maybe_unused]],

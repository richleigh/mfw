...
hidden if the `mfw_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `mfw_DEVELOPER_MODE` to the configure
...
Runs the executable target `mfw_exe`.
